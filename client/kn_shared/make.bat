...
cl -MT -Fekn_shared -LD -O2s -nologo -DKN_SHARED_EXPORTS *.c -link /MACHINE:X86 kn_shared.res kernel32.lib user32.lib shlwapi.lib shell32.lib comctl32.lib gdi32.lib advapi32.lib comdlg32.lib version.lib
