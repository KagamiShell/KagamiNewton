...
begin
 ...
 LabelGrade.Caption:=S_LABELGRADE;
...
const kinds : string = ('Замечание о работе компьютера'); //RUSSIAN only!
var h:integer;
...
begin
 ...
 filename:=IncludeTrailingPathDelimiter(string(p))+'kn_user_response.dat';
