...
cl -MT -Feks_shared -LD -O2s -nologo -DKS_SHARED_EXPORTS *.c -link /MACHINE:X86 ks_shared.res kernel32.lib user32.lib shlwapi.lib shell32.lib comctl32.lib gdi32.lib advapi32.lib comdlg32.lib version.lib
