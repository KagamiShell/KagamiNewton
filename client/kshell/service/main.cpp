  ...
  if ( StrStrI(PathFindFileName(our_exe),"tmp") )
     {
       ...
       ReadRegStr(HKLM,"SOFTWARE\\KagamineP\\KagamiShell\\KagamiShell","Install_Dir",inst_path,"");
            ...
            if ( sm->HighLevelUninstall() )
               {
                 ...
                 DeleteRegValue(HKLM,"SOFTWARE\\KagamineP\\KagamiShell\\KagamiShell","Install_Dir");
                 DeleteRegValue(HKLM,"SOFTWARE\\KagamineP\\KagamiShell\\KagamiShell","update_finish_flag");
