  ...
  if ( StrStrI(PathFindFileName(our_exe),"tmp") )
     {
       ...
       ReadRegStr(HKLM,"SOFTWARE\\Team KagamineP\\KagamiShell","Install_Dir",inst_path,"");
            ...
            if ( sm->HighLevelUninstall() )
               {
                 ...
                 DeleteRegValue(HKLM,"SOFTWARE\\Team KagamineP\\KagamiShell","Install_Dir");
                 DeleteRegValue(HKLM,"SOFTWARE\\Team KagamineP\\KagamiShell","update_finish_flag");
