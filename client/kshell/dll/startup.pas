...
begin
 ...
 if IsCyr then
  begin
   Caption:='Мастер настройки KagamiShell';
  ...
  begin
   ...
   ComboBox1.Items.Add('Student''s computer');
   ComboBox1.Items.Add('Teacher''s computer');
   ComboBox1.Items.Add('Operator''s computer');
