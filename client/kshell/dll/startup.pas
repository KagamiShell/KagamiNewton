...
begin
 ...
 Label7.Caption:='Обязательно выберите "Учительский компьютер" для учительского компьютера и "Ученический компьютер" для ученического компьютера!';
 ...
 if IsCyr then
  begin
   Caption:='Мастер установок KagamiShell Клиент';
   ComboBox1.Items.Add('Учительский компьютер');
   ComboBox1.Items.Add('Ученический компьютер');
   ComboBox1.Items.Add('Операторский компьютер');
