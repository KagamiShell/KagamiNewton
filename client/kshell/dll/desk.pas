...
procedure TKSDeskForm.WMQueryEndSession(var Message: TWMQueryEndSession);
begin
 Message.Result:=1;
end;

procedure TKSDeskForm.WMEndSession(var Message: TWMEndSession);
begin
 Message.Result:=0;
end;

procedure TKSDeskForm.WMEraseBkGnd(var Message: TWMEraseBkGnd);
begin
 Windows.PaintDesktop(Message.DC);
 Message.Result:=1;
end;

procedure TKSDeskForm.WMActivate(var Message: TWMActivate);
begin
 SetWindowPos(Handle,HWND_BOTTOM,0,0,0,0,SWP_NOMOVE or SWP_NOSIZE or SWP_NOACTIVATE or SWP_NOSENDCHANGING);
 Message.Result:=0;
end;

procedure TKSDeskForm.WMActivateApp(var Message: TWMActivateApp);
begin
 SetWindowPos(Handle,HWND_BOTTOM,0,0,0,0,SWP_NOMOVE or SWP_NOSIZE or SWP_NOACTIVATE or SWP_NOSENDCHANGING);
 Message.Result:=0;
end;

procedure TKSDeskForm.WMMouseActivate(var Message: TWMMouseActivate);
begin
 Message.Result:=MA_NOACTIVATE;
end;

procedure TKSDeskForm.WMClose(var Message: TWMClose);
begin
 Message.Result:=0;
end;

procedure TKSDeskForm.WMWindowPosChanging(var Message: TWMWindowPosChanging);
var p:PWINDOWPOS;
begin
...
procedure TKSDeskForm.WMSysKeyDown(var Message: TWMSysKeyDown);
begin
 Message.Result:=0;
end;

procedure TKSDeskForm.WMSysKeyUp(var Message: TWMSysKeyUp);
begin
 Message.Result:=0;
end;

procedure TKSDeskForm.WMKeyDown(var Message: TWMKeyDown);
begin
 Message.Result:=0;
end;

procedure TKSDeskForm.WMKeyUp(var Message: TWMKeyUp);
begin
 Message.Result:=0;
end;

procedure TKSDeskForm.WMSysChar(var Message: TWMSysChar);
begin
 Message.Result:=0;
end;
...
procedure TKSDeskForm.MyNavigate(const url:string);
begin
 FreeAndNil(theme);
