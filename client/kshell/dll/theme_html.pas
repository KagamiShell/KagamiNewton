...
type
     ...
     private
      ...
      function KNGetComputerLoc(Params: array of OleVariant): OleVariant;
      function KNGetComputerDesc(Params: array of OleVariant): OleVariant;
...
begin
 ...
 // and doing sheet-animation via PostMessage(KN_SETACTIVESHEET)
...
// WebBrowser.DPIAware:=true;
 ...
 WebBrowser.Bind('getComputerLoc',KNGetComputerLoc);
 WebBrowser.Bind('getComputerDesc',KNGetComputerDesc);
...
function TThemeHTML.KNGetComputerLoc(Params: array of OleVariant): OleVariant;
begin
 if (conn<>nil) and (@conn.GetComputerLoc<>nil) then
   Result:=string(conn.GetComputerLoc())
 else
   Result:=unassigned;
end;


function TThemeHTML.KNGetComputerDesc(Params: array of OleVariant): OleVariant;
begin
 if (conn<>nil) and (@conn.GetComputerDesc<>nil) then
   Result:=string(conn.GetComputerDesc())
 else
   Result:=unassigned;
end;


function TThemeHTML.KNGetStudentSessionName(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KNGetNumSheets(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KNGetSheetName(Params: array of OleVariant): OleVariant;
var idx:integer;
begin
 Result:=unassigned;
...
function TThemeHTML.KNIsSheetActive(Params: array of OleVariant): OleVariant;
var idx:integer;
begin
 Result:=unassigned;
...
function TThemeHTML.KNSetSheetActive(Params: array of OleVariant): OleVariant;
var idx:integer;
    state:boolean;
begin
 Result:=unassigned;
...
function TThemeHTML.KNGetSheetBGPic(Params: array of OleVariant): OleVariant;
var idx:integer;
begin
 Result:=unassigned;
...
function TThemeHTML.KNGetStatusString(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KNGetInfoText(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KNIsPageShaded(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KNGetResTranslatedUrl(Params: array of OleVariant): OleVariant;
...
function TThemeHTML.KNDoShellExec(Params: array of OleVariant): OleVariant;
var exe,args:string;
begin
 Result:=unassigned;
...
function TThemeHTML.KNGetInputText(Params: array of OleVariant): OleVariant;
...
function TThemeHTML.KNAlert(Params: array of OleVariant): OleVariant;
var text:string;
begin
 Result:=unassigned;
...
function TThemeHTML.KNInputWrapper(Params: array of OleVariant): OleVariant;
