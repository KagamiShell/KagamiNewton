...
type
  ...
  private
    ...
    function KSGetVipSessionName(Params: array of OleVariant): OleVariant;
...
function UrlUnescape(pszURL, pszUnescaped: pchar; pcchUnescaped: PDWORD; dwFlags: DWORD): HRESULT;
  stdcall; external 'shlwapi.dll' name 'UrlUnescapeA';
function UrlEscape(const pszURL: pchar; pszEscaped: pchar; pcchEscaped: PDWORD; dwFlags: DWORD): HRESULT;
  stdcall; external 'shlwapi.dll' name 'UrlEscapeA';
...
begin
 ...
 // and doing sheet-animation via PostMessage(KS_SETACTIVESHEET)
...
// WebBrowser.DPIAware:=true;
  ...
  WebBrowser.Bind('getVipSessionName', KSGetVipSessionName);
...
function TThemeHTML.KSGetMachineLoc(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KSGetMachineDesc(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KSGetVipSessionName(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KSGetNumSheets(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KSGetSheetName(Params: array of OleVariant): OleVariant;
var idx: integer;
begin
  Result := unassigned;
...
function TThemeHTML.KSIsSheetActive(Params: array of OleVariant): OleVariant;
var idx: integer;
begin
  Result := unassigned;
...
function TThemeHTML.KSSetSheetActive(Params: array of OleVariant): OleVariant;
var idx: integer;
  state: boolean;
begin
  Result := unassigned;
...
function TThemeHTML.KSGetSheetBGPic(Params: array of OleVariant): OleVariant;
var idx: integer;
begin
  Result := unassigned;
...
function TThemeHTML.KSGetStatusString(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KSGetInfoText(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KSIsPageShaded(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KSGetResTranslatedUrl(Params: array of OleVariant): OleVariant;
...
function TThemeHTML.KSDoShellExec(Params: array of OleVariant): OleVariant;
var exe, args: string;
begin
  Result := unassigned;
...
function TThemeHTML.KSGetInputText(Params: array of OleVariant): OleVariant;
...
function TThemeHTML.KSAlert(Params: array of OleVariant): OleVariant;
var text: string;
begin
  Result := unassigned;
...
function TThemeHTML.KSInputWrapper(Params: array of OleVariant): OleVariant;
