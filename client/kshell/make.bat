...
if exist kncfg.dll del kncfg.dll
set cl=
cl -Fekncfg -nologo -DCFG_DLL -DNDEBUG /O2t /EHsc /MT /LD cfg_def.cpp cfg_impl.cpp cfg_vars.cpp f0.cpp md5.cpp kernel32.lib user32.lib advapi32.lib shlwapi.lib ws2_32.lib ..\kn_shared\kn_shared.lib
if %ERRORLEVEL% NEQ 0 pause
if exist *.exp del *.exp
if exist *.lib del *.lib
if exist *.obj del *.obj
if exist *.pch del *.pch
if exist kncfg.dll copy /Y kncfg.dll ..\..\admin\test\
