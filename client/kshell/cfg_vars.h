...
#ifndef ___CFG_VAKN_H___
#define ___CFG_VAKN_H___
...
extern TPATH student_basefolder;
extern int student_folder_limit;
extern BOOL force_studentlogin_from_api;
