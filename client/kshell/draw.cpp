...
void Draw_Theme_Sheet(HDC hdc,const RECT *r,int state,const char *text,HICON icon,int bold,int highlited,BOOL show_pointer,BOOL centered,int fontsize)
{
  ...
  if ( show_pointer )
     rr.right -= 8;
  font = CreateFont(-fontsize,0,0,0,bold?FW_BOLD:FW_NORMAL,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH,"Segoe UI");
