...
enum {
COMPUTER_TYPE_STUDENTPC = 1,
COMPUTER_TYPE_STUDENTLAPTOP = 2,
COMPUTER_TYPE_TEACHERPC = 4,
COMPUTER_TYPE_TEACHERLAPTOP = 8,
COMPUTER_TYPE_TERMINAL = 16,
COMPUTER_TYPE_HOME = 32,
COMPUTER_TYPE_OTHER = 64,
COMPUTER_TYPE_ALL = 0xFFFFFFFF,
};
...
class CSheet
{
  ...
  public:
          ...
          const char* GetStudentUsers() const { return GetNonNullString(s_student_users); }
