...
NETGUID_ALL_OPERATOKN_WITHME    = 0xFFFFFFFA,
NETGUID_ALL_OPERATOKN_WITHOUTME = 0xFFFFFFF9,
NETGUID_ALL_COMPUTEKN_WITHME    = 0xFFFFFFF8,
...
NETCMD_BLOCKCOMPUTER         = 0xAD130007,
NETCMD_UNBLOCKCOMPUTER       = 0xAD130008,
...
NETCMD_BODYSTUDENT_REQ          = 0xAD13000E,
NETCMD_BODYSTUDENT_ACK          = 0xAD13000F,
...
// error codes
enum {
NETERR_STUDENT_NOERROR = 0,
NETERR_STUDENT_NORESULT = -1,
NETERR_STUDENT_WRONGLOGIN = -3,
NETERR_STUDENT_ALREADYEXIST = -4,
NETERR_STUDENT_UNKNOWN = -5,
NETERR_STUDENT_NEWSERVER = -6,
...
#define NETPARM_S_STUDENTSESSION      "sStudentSession"
#define NETPARM_S_CLASS           "sClass"
#define NETPARM_S_COMPUTERLOC      "sComputerLoc"
#define NETPARM_S_COMPUTERDESC     "sComputerDesc"
