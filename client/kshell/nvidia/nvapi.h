...
#define NVAPI_MAX_THERMAL_SENSOKN_PER_GPU 3
...
typedef struct
{
    ...
    } sensor[NVAPI_MAX_THERMAL_SENSOKN_PER_GPU];
...
//                  Thermal sensors are indexed 0 to NVAPI_MAX_THERMAL_SENSOKN_PER_GPU-1.
