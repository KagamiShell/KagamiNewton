...
BOOL IsRemoteDesktopRunning(void)
{
  ...
  HANDLE m = OpenMutex(READ_CONTROL,FALSE,KSRD_MUTEX);
  if ( m )
     {
       rc = TRUE;
       CloseHandle(m);
       ...
       if ( !lstrcmp(s_class,"#32770") ) 
          {
            ...
            if ( !lstrcmpi(s_win,"��������� ���������� �������") ) //todo:english
               {
            ...
            if ( !lstrcmpi(s_win,"�����������") || !lstrcmpi(s_win,"Restrictions") )
               {
                 HWND w_ok = GetDlgItem(w,IDOK);
                 HWND w_cancel = GetDlgItem(w,IDCANCEL);
                 ...
                 if ( !w_ok && w_cancel )
                    {
                      HWND w2 = FindWindowEx(w,NULL,"Static","�������� �������� ���������� ����������� ��� ���������� �����������. ���������� � �������������� ����.");
