...
{
  const char *szClassName = "_KSMessageClass";
  const char *szDesktopName = "_KSMessageDesktop";
...
static const char *szShaderClass = "_KSShaderClass";
static const char *szShaderProp = "_KSShaderProp";
