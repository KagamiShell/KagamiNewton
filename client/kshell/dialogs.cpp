...
{
  const char *szClassName = "_KNMessageClass";
  const char *szDesktopName = "_KNMessageDesktop";
    ...
    case WM_DESTROY:
                       {
                         ...
                         ReleaseCapture();
                         PostMessage(GetMainWnd(),KN_DESTROYSHADER,(unsigned)shader,0);
                       }
                       return 0;
  }
...
static const char *szShaderClass = "_KNShaderClass";
static const char *szShaderProp = "_KNShaderProp";
