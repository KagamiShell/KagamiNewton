...
static const char* __cdecl D_GetComputerLoc()
{
  return computer_loc;
}

static const char* __cdecl D_GetComputerDesc()
{
  return computer_desc;
}

static const char* __cdecl D_GetStudentSessionName()
{
...
{
  PostMessage(GetMainWnd(),KN_SETSHEETACTIVEBYIDX,idx,active);
}
...
static const struct {
   ...
   const char* (__cdecl *GetComputerLoc)();
   const char* (__cdecl *GetComputerDesc)();
   const char* (__cdecl *GetStudentSessionName)();
