...
{
    { COMPUTER_TYPE_GAMECLUB|COMPUTER_TYPE_INETCAFE|COMPUTER_TYPE_HOME,
    ...
    { COMPUTER_TYPE_OPERATOR|COMPUTER_TYPE_ORGANIZATION|COMPUTER_TYPE_OTHER,
    ...
    { COMPUTER_TYPE_GAMECLUB | COMPUTER_TYPE_INETCAFE,
