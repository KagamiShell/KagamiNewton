...
static const TDEFSHORTCUT def_shortcut_02 =
    { 3131,
      "%KS_FOLDER%\\bodywb.exe","-simple https://www.kagaminep.ru",
      3221,
      3132 };
...
static const TDEFITEMLIST2 def_disable_windows[] = 
{
  ...
  {TRUE, "__oxFrame.class__",           "���������"},
  {TRUE, "__oxFrame.class__",           "���������"},
  {TRUE, "#32770",                      "��� ���������"},
  {TRUE, "#32770",                      "My preferences"},
  {TRUE, "bosa_sdm_*",                  "���������� �����������"},
  {TRUE, "USurface_*",                  "������� ����������"},
  {FALSE,"USurface_*",                  "��������� - Steam"},
  {TRUE, "USurface_*",                  "�������� ����"},
  {TRUE, "USurface_*",                  "���������� ����"},
  {FALSE,"USurface_*",                  "���������"},
...
static const TDEFITEMLIST2 def_autorun_items[] = 
{
  ...
  {FALSE,"Start Page","$bodywb -simple https://kagaminep.ru"},
{FALSE,NULL,NULL} //terminator
};
...
{
  {TRUE, (const char*)(3195),"%KS_FOLDER%\\bodyminimize.exe"},
  {TRUE, (const char*)(3194),"%KS_FOLDER%\\bodywb.exe"},
  {TRUE, (const char*)(3193),"%KS_FOLDER%\\bodyexpl.exe"},
  {TRUE, (const char*)(3192),"%KS_FOLDER%\\bodyburn.exe"},
  {TRUE, (const char*)(3191),"%KS_FOLDER%\\bodymail.exe"},
  {FALSE,(const char*)(3190),"%KS_FOLDER%\\bodyscan.exe"},
  {TRUE, (const char*)(3189),"%KS_FOLDER%\\bodytm.exe"},
  {FALSE,(const char*)(3188),"%WinDir%\\System32\\calc.exe"},
  {FALSE,(const char*)(3187),"%KS_FOLDER%\\bodycalc.exe"},
  {TRUE, (const char*)(3186),"%KS_FOLDER%\\bodymouse.exe"},
{FALSE,NULL,NULL} //terminator
};
...
static const TGLOBALCFGITEM cfg_items[] = 
{
  ...
  { NULL, FALSE, "curr_desktop_theme",             CFG_TYPE_PATH,    &curr_desktop_theme,              _C("%KS_FOLDER%\\default\\themes\\05.theme") },
  { NULL, FALSE, "dont_show_theme_errors",         CFG_TYPE_BOOL,    &dont_show_theme_errors,          FALSE },
  { NULL, FALSE, "html_status_text1",              CFG_TYPE_STRING,  &html_status_text1,               _C("%TIME% (%DATE% - %DOW%)") },
  ...
  { "fav_path",
    TRUE,  "fav_path",                             CFG_TYPE_PATH,    &fav_path,                        FALSE },
  { "disallow_add2fav",
...
class CConfig
{
          static const int MAXLISTITEMS_BWC = 200;  // the same value in rssettings\setupvars.pas, ks_shared and some bodytools
