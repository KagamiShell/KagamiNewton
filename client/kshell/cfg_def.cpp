...
#define S_SH_S_STUDENT_USERS              "s_student_users"
...
int time_min;
int time_max;
const char *student_users;
int rules_id;
BOOL is_internet;
} TDEFSHEET;


static const TDEFSHEET def_sheet_action         = {3118,NULL,RGB(249,135,60),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vid01.wmv","%KN_FOLDER%\\default\\bg\\pic01_resize.jpg",0,24,NULL,-1,FALSE};
static const TDEFSHEET def_sheet_internet       = {3119,NULL,RGB(94,204,51),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vid02.wmv","%KN_FOLDER%\\default\\bg\\pic02_resize.jpg",0,24,NULL,-1,TRUE};
static const TDEFSHEET def_sheet_rpg            = {3120,NULL,RGB(94,196,55),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vid03.wmv","%KN_FOLDER%\\default\\bg\\pic03_resize.jpg",0,24,NULL,-1,FALSE};
static const TDEFSHEET def_sheet_adults         = {3121,"%KN_FOLDER%\\default\\icons\\icon01.ico",RGB(244,165,45),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vid04.wmv","%KN_FOLDER%\\default\\bg\\pic04_resize.jpg",23,6,NULL,3127,FALSE};
static const TDEFSHEET def_sheet_music          = {3122,NULL,RGB(243,140,65),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vplugins\\vp_voxel.dll","%KN_FOLDER%\\default\\bg\\pic05_resize.jpg",0,24,NULL,-1,FALSE};
static const TDEFSHEET def_sheet_programs       = {3123,NULL,RGB(255,255,255),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vid06.wmv","%KN_FOLDER%\\default\\bg\\pic06_resize.jpg",0,24,NULL,-1,FALSE};
static const TDEFSHEET def_sheet_simulators     = {3124,NULL,RGB(106,172,156),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vid07.wmv","%KN_FOLDER%\\default\\bg\\pic07_resize.jpg",0,24,NULL,-1,FALSE};
static const TDEFSHEET def_sheet_strategies     = {3125,NULL,RGB(171,164,163),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vid08.wmv","%KN_FOLDER%\\default\\bg\\pic08_resize.jpg",0,24,NULL,-1,FALSE};
static const TDEFSHEET def_sheet_films          = {3126,NULL,RGB(131,226,217),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\vid09.wmv","%KN_FOLDER%\\default\\bg\\pic09_resize.jpg",0,24,NULL,-1,FALSE};
static const TDEFSHEET def_sheet_programs_ts    = {3123,NULL,RGB(255,255,255),0xA0A0A0,NULL,NULL,0,24,NULL,-1,FALSE};
static const TDEFSHEET def_sheet_programs_other = {3123,NULL,RGB(255,255,255),0xA0A0A0,"%KN_FOLDER%\\default\\bg\\pic06.jpg","%KN_FOLDER%\\default\\bg\\pic06_resize.jpg",0,24,NULL,-1,FALSE};
...
static const TDEFSHORTCUT def_shortcut_00 =
    { 3128,
      "https://shell.kagaminep.ru",NULL,
      -1,
      -1 };
static const TDEFSHORTCUT def_shortcut_01 =
    { 3129,
      "%KN_FOLDER%\\bodywb.exe",NULL,
      3221,
      3130 };
static const TDEFSHORTCUT def_shortcut_02 =
    { 3131,
      "C:\\Program Files\\Mozilla Firefox\\firefox.exe","https://shell.kagaminep.ru",
      3221,
      3132 };
static const TDEFSHORTCUT def_shortcut_03 =
    { 3133,
      "%KN_FOLDER%\\bodymail.exe",NULL,
      3221,
      3134 };
static const TDEFSHORTCUT def_shortcut_04 =
    { 3135,
      "%KN_FOLDER%\\bodyexpl.exe",NULL,
      3222,
      3136 };
...
static const TDEFSHORTCUT def_shortcut_30 =
    { 3236,
      "%KN_FOLDER%\\bodyrecycle.exe",NULL,
      3222,
      3237 };
...
{
    { COMPUTER_TYPE_STUDENTPC|COMPUTER_TYPE_STUDENTLAPTOP|COMPUTER_TYPE_HOME,
    ...
    { COMPUTER_TYPE_TEACHERPC|COMPUTER_TYPE_TEACHERLAPTOP|COMPUTER_TYPE_OTHER,
    ...
    { COMPUTER_TYPE_STUDENTPC | COMPUTER_TYPE_STUDENTLAPTOP,
...
static const TDEFITEMLIST2 def_autorun_items[] = 
{
  ...
  {FALSE,"Start Page","$bodywb -simple https://shell.kagaminep.ru"},
{FALSE,NULL,NULL} //terminator
};
...
{
  {TRUE, (const char*)(3195),"%KN_FOLDER%\\bodyminimize.exe"},
  {TRUE, (const char*)(3194),"%KN_FOLDER%\\bodywb.exe"},
  {TRUE, (const char*)(3193),"%KN_FOLDER%\\bodyexpl.exe"},
  {TRUE, (const char*)(3192),"%KN_FOLDER%\\bodyburn.exe"},
  {TRUE, (const char*)(3191),"%KN_FOLDER%\\bodymail.exe"},
  {FALSE,(const char*)(3190),"%KN_FOLDER%\\bodyscan.exe"},
  {TRUE, (const char*)(3189),"%KN_FOLDER%\\bodytm.exe"},
  {FALSE,(const char*)(3188),"%WinDir%\\System32\\calc.exe"},
  {FALSE,(const char*)(3187),"%KN_FOLDER%\\bodycalc.exe"},
  {TRUE, (const char*)(3186),"%KN_FOLDER%\\bodymouse.exe"},
{FALSE,NULL,NULL} //terminator
};
...
static const TGLOBALCFGITEM cfg_items[] = 
{
  ...
  { NULL, FALSE, "curr_desktop_theme",             CFG_TYPE_PATH,    &curr_desktop_theme,              _C("%KN_FOLDER%\\default\\themes\\05.theme") },
  { NULL, FALSE, "dont_show_theme_errors",         CFG_TYPE_BOOL,    &dont_show_theme_errors,          FALSE },
  { NULL, FALSE, "html_status_text1",              CFG_TYPE_STRING,  &html_status_text1,               _C("%TIME% (%DATE% - %DOW%) %STUDENT%") },
  ...
  { "student_in_menu", 
    FALSE, "student_in_menu",                          CFG_TYPE_BOOL,    &student_in_menu,                     TRUE },
  ...
  // файлы: перенаправление для учеников
  ...
  { NULL, FALSE, "student_basefolder",                 CFG_TYPE_PATH,    &student_basefolder,                  NULL },
  { NULL, FALSE, "student_folder_limit",               CFG_TYPE_INT,     &student_folder_limit,                0 },
  { NULL, FALSE, "force_studentlogin_from_api",        CFG_TYPE_BOOL,    &force_studentlogin_from_api,         TRUE },
  ...
  { "fav_path",
    TRUE,  "fav_path",                             CFG_TYPE_PATH,    &fav_path,                        _C("%KN_STUDENTFOLDER%\\IEFav") },
  { "disallow_add2fav",
...
class CConfig
{
          static const int MAXLISTITEMS_BWC = 200;  // the same value in rssettings\setupvars.pas, kn_shared and some bodytools
  
  public:
          static void ReadConfig(const void *block,int block_size,int lang,int computer_type);
  ...
  private:
          ...
          static BOOL ReadConfigShortcut(const char* &src,int &src_size,CSheet *sh,int lang,int computer_type);
          static BOOL ReadConfigSheet(const char* &src,int &src_size,CContent *cnt,int lang,int computer_type);
          static BOOL ReadConfigItem(const void *block,int block_size,const char *d_name,int d_type,void *d_value,int lang,int computer_type);
          static void ReadConfigItemsList(const TGLOBALCFGITEM *list,int list_count,const char *block,int block_size,int lang,int computer_type);
          static void GetDefConfigItem(const TGLOBALCFGITEM *item,int lang,int computer_type);
          static void LoadDefShortcut(CContent *dest,const TDEFSHEET *def_sheet,const TDEFSHORTCUT *def_shortcut,int lang,int computer_type);
...
BOOL CConfig::ReadConfigShortcut(const char* &src,int &src_size,CSheet *sh,int lang,int computer_type)
{
  int size;
  ...
  ReadConfigItemsList(list,sizeof(list)/sizeof(list[0]),src,size,lang,computer_type);
...
BOOL CConfig::ReadConfigSheet(const char* &src,int &src_size,CContent *cnt,int lang,int computer_type)
{
  int sizeof_header;
  ...
  const TGLOBALCFGITEM list[] = 
  {
    ...
    { NULL, FALSE, S_SH_S_STUDENT_USERS,       CFG_TYPE_STRING,  &s_student_users      ,  NULL },
  ...
  ReadConfigItemsList(list,sizeof(list)/sizeof(list[0]),src,sizeof_header,lang,computer_type);
  ...
  CSheet *sh = new CSheet(s_name,s_icon_path,i_color,i_bg_color,s_bg_pic,s_bg_thumb_pic,i_time_min,i_time_max,s_student_users,s_rules,is_internet_sheet);
  ...
  for ( int n = 0; n < numshortcuts; n++ )
      {
        if ( !ReadConfigShortcut(src,src_size,sh,lang,computer_type) )
           {
             delete sh;
             return FALSE;
           }
...
BOOL CConfig::ReadConfigItem(const void *block,int block_size,const char *d_name,int d_type,void *d_value,int lang,int computer_type)
{
  BOOL rc = FALSE;
                                 ...
                                 if ( c_size >= sizeof(int) )
                                    {
                                      ...
                                      for ( int n = 0; n < count; n++ )
                                          {
                                            if ( !ReadConfigSheet(src,src_size,cnt,lang,computer_type) )
                                               break;
                                          }
                                    }
                                 break;
...
void CConfig::LoadDefShortcut(CContent *cnt,const TDEFSHEET *def_sheet,const TDEFSHORTCUT *def_shortcut,int lang,int computer_type)
{
            ...
            if ( !sheet )
               {
                 ...
                 const char *student_users = def_sheet->student_users;
                 const char *rules = LS(def_sheet->rules_id,lang);
                 BOOL is_internet = def_sheet->is_internet;

                 sheet = new CSheet(name,icon_path,color,bg_color,bg_pic,bg_thumb_pic,time_min,time_max,student_users,rules,is_internet);
                 cnt->AddSheet(sheet);
               }
...
void CConfig::GetDefConfigItem(const TGLOBALCFGITEM *item,int lang,int computer_type)
{
    ...
    case CFG_TYPE_CONTENT:
                           {
                             ...
                             if ( src )
                                {
                                  do {
                                   int type_mask = src->computer_type_mask;
                                   ...
                                   if ( type_mask & computer_type )
                                      {
                                        LoadDefShortcut(dest,def_sheet,def_shortcut,lang,computer_type);
                                      }
...
void CConfig::ReadConfigItemsList(const TGLOBALCFGITEM *list,int list_count,const char *block,int block_size,int lang,int computer_type)
{
  for ( int n = 0; n < list_count; n++ )
      {
        const TGLOBALCFGITEM *item = list+n;

        if ( !ReadConfigItem(block,block_size,item->name,item->type,item->value,lang,computer_type) )
           {
             GetDefConfigItem(item,lang,computer_type);
           }
      }
}


void CConfig::ReadConfig(const void *block,int block_size,int lang,int computer_type)
{
  ReadConfigItemsList(cfg_items,sizeof(cfg_items)/sizeof(cfg_items[0]),(const char*)block,block_size,lang,computer_type);
}
...
void CConfig::WriteSingleSheet(const CSheet *sheet,CBuff &buff)
{
  ...
  const char* s_student_users = sheet->GetStudentUsers();
  ...
  const TGLOBALCFGITEM list[] = 
  {
    ...
    { NULL, FALSE, S_SH_S_STUDENT_USERS,       CFG_TYPE_STRING,  (void*)s_student_users       , NULL },
  ...
  if ( sh )
     {
       ...
       lstrcpy(out->s_student_users,sh->GetStudentUsers());
...
CFG_EXPORT void CFG_DECL CfgReadConfig(const void *block,int block_size,int lang,int computer_type)
{
  CConfig::ReadConfig(block,block_size,lang,computer_type);
}
