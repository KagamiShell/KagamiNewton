...
void CTrayBalloon::Show(const CTrayIcon *newicon,const char *szInfo,const char *szInfoTitle,DWORD uTimeout,DWORD dwInfoFlags)
{
  ...
  this->font1 = CreateFont(-10,0,0,0,FW_BOLD,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH,"Segoe UI");
  this->font2 = CreateFont(-10,0,0,0,FW_NORMAL,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH,"Segoe UI");
