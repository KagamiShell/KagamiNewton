...
const WCHAR *g_text_regular = L"Оболочка временно отключена до завершения сеанса или перезагрузки.";
const WCHAR *g_text_warn = L"Внимание!\nСеанс завершится через %d секунд.";
WCHAR g_buff[200];
...
void Paint(HWND hwnd,HDC hdc)
{
  ...
  HFONT font = CreateFont(-12,0,0,0,FW_BOLD,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH,"Segoe UI");
...
{
  CreateMutex(NULL,FALSE,"_ksoffindic_Mutex");
  ...
  const char *szClassName = "_ksoffindic_wnd_class";
