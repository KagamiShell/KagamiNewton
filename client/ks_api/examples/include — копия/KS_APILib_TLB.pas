...
const
  KSS_OFF = $00000000;
  KSS_TURNEDON = $00000001;
  KSS_ACTIVE = $00000003;
  KSS_INVALID = $FFFFFFFF;
...
// *********************************************************************//
  ...
  KSHELLSTATE = __MIDL_IKagamiShell_0001;
...
function TKagamiShell.GetFolderPath(dwFolderType: KSHELLFOLDER; lpszPath: PChar;
