...
BOOL RS_GetCompNumber(DWORD* lpdwNum);
...
BOOL RS_StudentLogin(LPCSTR lpszLogin, LPCSTR lpszPassword, BOOL bWait);
BOOL RS_StudentRegister(LPCSTR lpszLogin, LPCSTR lpszPassword, BOOL bWait);
BOOL RS_StudentLogout(BOOL bWait);
