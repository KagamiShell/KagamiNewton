  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          MessageBox(0, PChar('Длина пути превышает установленный предел:'#10#13
            + s + #10#13'Обратитесь к разработчику'), 'Ошибка', MB_OK);
          Result := false;
          Exit;
        end;
        ...
        if h = 0 then
        begin
          MessageBox(0, PChar('Ошибка при передаче пути:'#10#13 + s +
            #10#13'Обратитесь к разработчику'), 'Ошибка', MB_OK);
          Result := false;
          Exit;
        end;
