...
#define S_NETBTTEXT               "Ученику \"%s\\%s (%s\\%s)\" необходимо загрузить файлы через Bluetooth из папки:\n\n%s\n\nЗапустить программу работы с Bluetooth?"
#define S_ERRNOBTFILES            "Не найдены файлы для загрузки"
#define S_NETDATARETRIVAL         "Сбор данных"
#define S_STOP                    "Стоп"
#define S_NETDATARETRIEVED        "Данные получены от %d компьютера(-ов) из %d"
