...
(
  (uid:FID_REBOOT;               groupname:'��������';           caption:'������������� ������';                hint:'������������� ������';
   imageindex:0;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_REBOOTSHUTDOWN),
  (uid:FID_SHUTDOWN;             groupname:'��������';           caption:'��������� ������';                    hint:'��������� ������';
   imageindex:1;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_REBOOTSHUTDOWN),
  (uid:FID_HIBERNATE;            groupname:'��������';           caption:'������ �����';                        hint:'������� � ������ �����';
   imageindex:30;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_REBOOTSHUTDOWN),
  (uid:FID_SUSPEND;              groupname:'��������';           caption:'������ �����';                        hint:'������� � ������ �����';
   imageindex:31;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_REBOOTSHUTDOWN),
  (uid:FID_LOGOFF;               groupname:'��������';           caption:'��������� �����';                     hint:'��������� ����� ������������ Windows (LogOff)';
   imageindex:2;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_LOGOFF),
  (uid:FID_KILLALL;              groupname:'��������';           caption:'����� ��� ������';                    hint:'����� ��� �������� ������ ������������';
   imageindex:3;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_KILLTASKS),
  (uid:FID_SENDMESSAGE;          groupname:'��������';           caption:'������� ���������';                   hint:'�������� ��������� ������������';
   imageindex:4;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_SENDMESSAGE),
  (uid:FID_TURNMONITORON;        groupname:'������';             caption:'�������� �������';                    hint:'��������� �������� ������������';
   imageindex:5;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_TURNMONITOR),
  (uid:FID_TURNMONITOROFF;       groupname:'������';             caption:'��������� �������';                   hint:'���������� �������� ������������';
   imageindex:6;
   button:nil;  menuitem:nil;   no_self_exec:true;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_TURNMONITOR),
  (uid:FID_UNBLOCK;              groupname:'������';             caption:'�������������� ������������';         hint:'��������� ����� ���������� ������������';
   imageindex:7;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_TURNBLOCK),
  (uid:FID_BLOCK;                groupname:'������';             caption:'������������� ������������';          hint:'�������� ����� ���������� ������������';
   imageindex:8;
   button:nil;  menuitem:nil;   no_self_exec:true;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_TURNBLOCK),
  (uid:FID_RESTOREVMODE;         groupname:'������';             caption:'������������ ����������';             hint:'������������ ���������� �� ��������������';
   imageindex:9;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_RESTOREVMODE),
  (uid:FID_SOMEINFOCOMP;         groupname:'����������';         caption:'����� �������� (Comp)';               hint:'�������� ����� �������� � �������';
   imageindex:10;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_MACHINESINFO{''}),
  (uid:FID_SOMEINFOUSER;         groupname:'����������';         caption:'����� �������� (User)';               hint:'�������� ����� �������� � �������������';
   imageindex:10;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_MACHINESINFO{''}),
  (uid:FID_EXECSTAT;             groupname:'����������';         caption:'���������� �������';                  hint:'���������� ������� ���������� �� ���������� �������';
   imageindex:11;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:''{UR_X_MACHINESINFO}),
  (uid:FID_SCREEN;               groupname:'����������';         caption:'������ �������������';                hint:'�������� ������� ������� �������������';
   imageindex:12;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:''{UR_X_MACHINESINFO}),
  (uid:FID_WEBCAM;               groupname:'����������';         caption:'����������� � ���-�����';             hint:'�������� ������� ����������� � ���-�����';
   imageindex:13;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:''{UR_X_MACHINESINFO}),
  (uid:FID_SCREENCONTROL;        groupname:'����������';         caption:'���������� �������';                  hint:'����������� ���������� �� �������� �������������';
   imageindex:14;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:FALSE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:''{UR_X_MACHINESINFO}),
  (uid:FID_WEBCAMCONTROL;        groupname:'����������';         caption:'���������� � ���-�����';              hint:'����������� ���������� � ���-�����';
   imageindex:15;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:FALSE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:''{UR_X_MACHINESINFO}),
  (uid:FID_TURNSHELLON;          groupname:'�����������������';  caption:'�������� ����';                       hint:'�������� ���� ��� ������ ��� ���� ������������� ������';
   imageindex:16;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_TURNSHELL),
  (uid:FID_TURNSHELLOFF;         groupname:'�����������������';  caption:'��������� ����';                      hint:'��������� ���� ��� ������ ��� ���� ������������� ������';
   imageindex:17;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_TURNSHELL),
  (uid:FID_TURNCURRENTSHELLOFF;  groupname:'�����������������';  caption:'��������� ���� ����� ������������';   hint:'��������� ���� ������ �� ���� ������� ����������� ������������ Windows ��������� �����';
   imageindex:17;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_TURNSHELL),
  (uid:FID_TEMPTURNSHELLOFF;     groupname:'�����������������';  caption:'�������� ��������� ����';             hint:'�������� ��������� ���� (�� ������������ ��� LogOff)';
   imageindex:37;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_TURNSHELL),
  (uid:FID_TURNAUTOLOGONON;      groupname:'�����������������';  caption:'�������� AutoLogon';                  hint:'�������� �������������� ����� ������������� �� ����������';
   imageindex:18;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_TURNAUTOLOGON),
  (uid:FID_TURNAUTOLOGONOFF;     groupname:'�����������������';  caption:'��������� AutoLogon';                 hint:'��������� �������������� ����� ������������� �� ����������';
   imageindex:19;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_TURNAUTOLOGON),
  (uid:FID_TIMESYNC;             groupname:'�����������������';  caption:'���������������� �����';              hint:'���������������� ����� �� ���������� ������� � ��������';
   imageindex:20;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;    allow_user:FALSE;
   ur:UR_X_TIMESYNC),
  (uid:FID_CLEAREXECSTAT;        groupname:'�����������������';  caption:'�������� ����������';                 hint:'�������� ���������� ������� ����������';
   imageindex:21;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_CLEARSTAT),
  (uid:FID_CLIENTUPDATE;         groupname:'�����������������';  caption:'�������� ���������� �����';            hint:'�������� ���������� ����� �� ��������� ������� �� ����� ������';
   imageindex:29;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;     allow_user:FALSE;
   ur:UR_X_CLIENTUPDATE),
  (uid:FID_CLIENTUNINSTALL;      groupname:'�����������������';  caption:'������� ���������� �����';            hint:'������� ���������� ����� ��� ����� �� ��������� �������';
   imageindex:36;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;     allow_user:FALSE;
   ur:UR_X_CLIENTUNINSTALL),
  (uid:FID_EXECUTECMDLINE;       groupname:'�����';              caption:'���������';                           hint:'������ ���������� �� ������ ������������';
   imageindex:22;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_EXECUTE),
  (uid:FID_EXECUTEREG;           groupname:'�����';              caption:'�������� � ������';                   hint:'��������� .reg-���� �� ������ ������������';
   imageindex:23;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_EXECUTE),
  (uid:FID_EXECUTEBAT;           groupname:'�����';              caption:'��������� bat-����';                  hint:'��������� .bat-���� �� ������ ������������';
   imageindex:24;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_EXECUTE),
  (uid:FID_COPYFILES;            groupname:'�����';              caption:'���������� ����� �������������';      hint:'���������� ����� �� ���������������� ������';
   imageindex:25;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_COPYDELFILES),
  (uid:FID_DELETEFILES;          groupname:'�����';              caption:'������� �����';                       hint:'������� ������������� ����� �� ���������������� �������';
   imageindex:26;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:FALSE;    allow_user:TRUE;
   ur:UR_X_COPYDELFILES),
  (uid:FID_RFM;                  groupname:'����������';         caption:'��������� �������� ��������';         hint:'��������� ��������� �������� �������� ��� ��������� �����';
   imageindex:27;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;     allow_user:FALSE;
   ur:UR_X_RFM),
  (uid:FID_RD;                   groupname:'����������';         caption:'���������� ������� ������';           hint:'��������� ��������� ���������� ������� ������';
   imageindex:28;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:FALSE; allow_computer:TRUE;     allow_user:FALSE;
   ur:UR_X_KSRD),
  (uid:FID_RLBINFO;              groupname:'Rollback (�����)';   caption:'������� ������ ������';               hint:'���������� ������� ��������� ������ ��� ��������� �����';
   imageindex:32;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;     allow_user:FALSE;
   ur:UR_X_ROLLBACK),
  (uid:FID_RLBSAVE1;             groupname:'Rollback (�����)';   caption:'��������� �� ���� ������������';      hint:'��������� ������ (��������� �����) �� ���� ������������';
   imageindex:33;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;     allow_user:FALSE;
   ur:UR_X_ROLLBACK),
  (uid:FID_RLBSAVE2;             groupname:'Rollback (�����)';   caption:'��������� �� ��� ������������';       hint:'��������� ������ (��������� �����) �� ��� ������������';
   imageindex:34;
   button:nil;  menuitem:nil;   no_self_exec:false;
   multiselect:TRUE;  allow_computer:TRUE;     allow_user:FALSE;
   ur:UR_X_ROLLBACK),
  (uid:FID_RLBHELP;              groupname:'Rollback (�����)';   caption:'������';                              hint:'������ �� �������� Rollback';
   imageindex:35;
   button:nil;  menuitem:nil;   no_self_exec:false;
...
begin
 ...
 if (TreeView.Selected<>nil) and (TreeView.Selected.Level>0) then
  begin
   ...
   list.Add(Format(S_INFOFMT_KSVER,[i.kagami_ver]));
       ...
       for m:=0 to TreeView.Items.Count-1 do
        with TreeView.Items[m] do
         if (Level=1) and
            ...
            //�� �������� ����� ��������� ������ machine_loc � machine_desc, � ���� ������� ����� ������ ����������, �� ������ ����� ��� �������� ��, ��� � comp_name ���������
