...
var
  functions: array [0..39] of TFunction =
    (
    (uid: FID_REBOOT; groupname: 'Действия';
    caption: 'Перезагрузить машину';
    hint: 'Перезагрузить машину';
    imageindex: 0;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_REBOOTSHUTDOWN),
    (uid: FID_SHUTDOWN; groupname: 'Действия'; caption: 'Выключить машину';
    hint: 'Выключить машину';
    imageindex: 1;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_REBOOTSHUTDOWN),
    (uid: FID_HIBERNATE; groupname: 'Действия'; caption: 'Спящий режим';
    hint: 'Переход в спящий режим';
    imageindex: 30;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_REBOOTSHUTDOWN),
    (uid: FID_SUSPEND; groupname: 'Действия'; caption: 'Ждущий режим';
    hint: 'Переход в ждущий режим';
    imageindex: 31;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_REBOOTSHUTDOWN),
    (uid: FID_LOGOFF; groupname: 'Действия'; caption: 'Завершить сеанс';
    hint: 'Завершить сеанс пользователя Windows (LogOff)';
    imageindex: 2;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_LOGOFF),
    (uid: FID_KILLALL; groupname: 'Действия'; caption: 'Снять все задачи';
    hint: 'Снять все активные задачи пользователя';
    imageindex: 3;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_KILLTASKS),
    (uid: FID_SENDMESSAGE; groupname: 'Действия'; caption: 'Послать сообщение';
    hint: 'Отправка сообщения пользователю';
    imageindex: 4;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_SENDMESSAGE),
    (uid: FID_TURNMONITORON; groupname: 'Режимы'; caption: 'Включить монитор';
    hint: 'Включение монитора пользователя';
    imageindex: 5;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_TURNMONITOR),
    (uid: FID_TURNMONITOROFF; groupname: 'Режимы'; caption: 'Выключить монитор';
    hint: 'Выключение монитора пользователя';
    imageindex: 6;
    button: nil; menuitem: nil; no_self_exec: true;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_TURNMONITOR),
    (uid: FID_UNBLOCK; groupname: 'Режимы';
    caption: 'Разблокировать пользователя';
    hint: 'Отключить экран блокировки пользователя';
    imageindex: 7;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_TURNBLOCK),
    (uid: FID_BLOCK; groupname: 'Режимы';
    caption: 'Заблокировать пользователя';
    hint: 'Включить экран блокировки пользователя';
    imageindex: 8;
    button: nil; menuitem: nil; no_self_exec: true;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_TURNBLOCK),
    (uid: FID_RESTOREVMODE; groupname: 'Режимы';
    caption: 'Восстановить видеорежим';
    hint: 'Восстановить видеорежим на первоначальный';
    imageindex: 9;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_RESTOREVMODE),
    (uid: FID_SOMEINFOCOMP; groupname: 'Информация';
    caption: 'Общие сведения (Comp)';
    hint: 'Получить общие сведения о машинах';
    imageindex: 10;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_MACHINESINFO{''}),
    (uid: FID_SOMEINFOUSER; groupname: 'Информация';
    caption: 'Общие сведения (User)';
    hint: 'Получить общие сведения о пользователях';
    imageindex: 10;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_MACHINESINFO{''}),
    (uid: FID_EXECSTAT; groupname: 'Информация';
    caption: 'Статистика запуска';
    hint: 'Статистика запуска приложений на клиентских машинах';
    imageindex: 11;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: ''{UR_X_MACHINESINFO}),
    (uid: FID_SCREEN; groupname: 'Информация';
    caption: 'Экраны пользователей';
    hint: 'Просмотр текущих экранов пользователей';
    imageindex: 12;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: ''{UR_X_MACHINESINFO}),
    (uid: FID_WEBCAM; groupname: 'Информация';
    caption: 'Изображения с веб-камер';
    hint: 'Просмотр текущих изображений с веб-камер';
    imageindex: 13;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: ''{UR_X_MACHINESINFO}),
    (uid: FID_SCREENCONTROL; groupname: 'Информация';
    caption: 'Наблюдение экранов';
    hint: 'Непрерывное наблюдение за экранами пользователей';
    imageindex: 14;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: FALSE; allow_computer: FALSE; allow_user: TRUE;
    ur: ''{UR_X_MACHINESINFO}),
    (uid: FID_WEBCAMCONTROL; groupname: 'Информация';
    caption: 'Наблюдение с веб-камер';
    hint: 'Непрерывное наблюдение с веб-камер';
    imageindex: 15;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: FALSE; allow_computer: FALSE; allow_user: TRUE;
    ur: ''{UR_X_MACHINESINFO}),
    (uid: FID_TURNSHELLON; groupname: 'Администрирование';
    caption: 'Включить шелл';
    hint: 'Включить шелл для одного или всех пользователей машины';
    imageindex: 16;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_TURNSHELL),
    (uid: FID_TURNSHELLOFF; groupname: 'Администрирование';
    caption: 'Отключить шелл';
    hint: 'Отключить шелл для одного или всех пользователей машины';
    imageindex: 17;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_TURNSHELL),
    (uid: FID_TURNCURRENTSHELLOFF; groupname: 'Администрирование';
    caption: 'Отключить шелл этого пользователя';
    hint: 'Отключить шелл только на этом текущем загруженном пользователе Windows выбранных машин';
    imageindex: 17;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_TURNSHELL),
    (uid: FID_TEMPTURNSHELLOFF; groupname: 'Администрирование';
    caption: 'Временно отключить шелл';
    hint: 'Временно отключить шелл (до перезагрузки или LogOff)';
    imageindex: 37;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_TURNSHELL),
    (uid: FID_TURNAUTOLOGONON; groupname: 'Администрирование';
    caption: 'Включить AutoLogon';
    hint: 'Включить автоматический логон пользователей на компьютере';
    imageindex: 18;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_TURNAUTOLOGON),
    (uid: FID_TURNAUTOLOGONOFF; groupname: 'Администрирование';
    caption: 'Отключить AutoLogon';
    hint: 'Отключить автоматический логон пользователей на компьютере';
    imageindex: 19;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_TURNAUTOLOGON),
    (uid: FID_TIMESYNC; groupname: 'Администрирование';
    caption: 'Синхронизировать время';
    hint: 'Синхронизировать время на клиентских машинах с сервером';
    imageindex: 20;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_TIMESYNC),
    (uid: FID_CLEAREXECSTAT; groupname: 'Администрирование';
    caption: 'Очистить статистику';
    hint: 'Очистить статистику запуска приложений';
    imageindex: 21;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_CLEARSTAT),
    (uid: FID_CLIENTUPDATE; groupname: 'Администрирование';
    caption: 'Обновить клиентскую часть';
    hint: 'Обновить клиентскую часть на выбранных машинах до новой версии';
    imageindex: 29;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_CLIENTUPDATE),
    (uid: FID_CLIENTUNINSTALL; groupname: 'Администрирование';
    caption: 'Удалить клиентскую часть';
    hint: 'Удалить клиентскую часть без шелла на выбранных машинах';
    imageindex: 36;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_CLIENTUNINSTALL),
    (uid: FID_EXECUTECMDLINE; groupname: 'Файлы'; caption: 'Выполнить';
    hint: 'Запуск приложений на машине пользователя';
    imageindex: 22;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_EXECUTE),
    (uid: FID_EXECUTEREG; groupname: 'Файлы'; caption: 'Добавить в реестр';
    hint: 'Запустить .reg-файл на машине пользователя';
    imageindex: 23;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_EXECUTE),
    (uid: FID_EXECUTEBAT; groupname: 'Файлы'; caption: 'Запустить bat-файл';
    hint: 'Запустить .bat-файл на машине пользователя';
    imageindex: 24;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_EXECUTE),
    (uid: FID_COPYFILES; groupname: 'Файлы';
    caption: 'Копировать файлы пользователям';
    hint: 'Копировать файлы на пользовательские машины';
    imageindex: 25;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_COPYDELFILES),
    (uid: FID_DELETEFILES; groupname: 'Файлы'; caption: 'Удалить файлы';
    hint: 'Удалить предописанные файлы на пользовательских машинах';
    imageindex: 26;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: FALSE; allow_user: TRUE;
    ur: UR_X_COPYDELFILES),
    (uid: FID_RFM; groupname: 'Управление';
    caption: 'Удаленный файловый менеджер';
    hint: 'Запустить удаленный файловый менеджер для выбранных машин';
    imageindex: 27;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_RFM),
    (uid: FID_RD; groupname: 'Управление';
    caption: 'Управление рабочим столом';
    hint: 'Запустить программу управления рабочим столом';
    imageindex: 28;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: FALSE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_KSRD),
    (uid: FID_RLBINFO; groupname: 'Rollback (откат)';
    caption: 'Текущий статус отката';
    hint: 'Показывает текущее состояние отката для выбранных машин';
    imageindex: 32;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_ROLLBACK),
    (uid: FID_RLBSAVE1; groupname: 'Rollback (откат)';
    caption: 'Сохранить на одну перезагрузку';
    hint: 'Сохранить данные (отключить откат) на одну перезагрузку';
    imageindex: 33;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_ROLLBACK),
    (uid: FID_RLBSAVE2; groupname: 'Rollback (откат)';
    caption: 'Сохранить на две перезагрузки';
    hint: 'Сохранить данные (отключить откат) на две перезагрузки';
    imageindex: 34;
    button: nil; menuitem: nil; no_self_exec: false;
    multiselect: TRUE; allow_computer: TRUE; allow_user: FALSE;
    ur: UR_X_ROLLBACK),
    (uid: FID_RLBHELP; groupname: 'Rollback (откат)'; caption: 'Помощь';
    hint: 'Помощь по функциям Rollback';
    imageindex: 35;
    button: nil; menuitem: nil; no_self_exec: false;
...
procedure TKSOperatorForm.CreateFunctionButtons();
var n, idx: integer;
  p: PFunction;
  page: TTabSheet;
  panel: TPanel;
...
procedure TKSOperatorForm.CreateFunctionPopup();
...
function TKSOperatorForm.IsSQLConnected: boolean;
begin
  Result := sql <> nil;
end;

procedure TKSOperatorForm.DefaultHandler(var Message);
begin
...
constructor TKSOperatorForm.CreateForm(p: PHostConnection);
var hIcon: cardinal;
begin
...
destructor TKSOperatorForm.Destroy;
begin
...
procedure TKSOperatorForm.SelfShow;
begin
  Visible := true;
...
procedure TKSOperatorForm.SelfHide;
begin
  Visible := false;
end;

function TKSOperatorForm.IsSelfVisible: boolean;
begin
  Result := Visible;
end;

function TKSOperatorForm.GetSelfHWND: HWND;
begin
  Result := Handle;
end;

procedure TKSOperatorForm.FormShow(Sender: TObject);
begin
  UpdateCompList();
  UpdateServerStatus();
  UpdateComputerMACs();
...
procedure TKSOperatorForm.FormResize(Sender: TObject);
var maxw: integer;
begin
...
procedure TKSOperatorForm.UpdateStatusString(panel: integer; s: string; process_messages: boolean);
begin
...
procedure TKSOperatorForm.UpdateView();
begin
...
procedure TKSOperatorForm.UpdateMachinesPage();
var item: TTreeNode;
  n:      integer;
  p:      PFUNCTION;
...
begin
 ...
 // memo
  ...
  begin
    ...
    list.Add(Format(S_INFOFMT_RPVER, [i.kagami_ver]));
...
procedure TKSOperatorForm.ButtonConnectClick(Sender: TObject);
var cnt: integer;
  err:   string;
begin
  ...
  begin
    ...
    begin
      cnt := 0;
      user_rights := '';
      if (not sql.Exec('SELECT user_rights FROM TDBUsers WHERE user_name=''' + sql.EscapeString(
        LoginForm.GetLogin) + '''', SQL_DEF_TIMEOUT, @cnt, SelectUserRightsCB, @user_rights))
        or (cnt <= 0) then
      begin
        user_rights := '';
...
procedure TKSOperatorForm.ButtonDisconnectClick(Sender: TObject);
begin
...
procedure TKSOperatorForm.ButtonChangePassClick(Sender: TObject);
...
procedure TKSOperatorForm.ButtonDBViewClick(Sender: TObject);
var s: string;
begin
  ...
  if IsSQLConnected then
    s := '"' + s + '" "' + LoginForm.GetServer + '" "' + inttostr(LoginForm.GetServerType) + '" "' +
      LoginForm.GetLogin + '" "' + LoginForm.GetPwd + '"';
  ExecLocalFile(PATH_DBVIEW, s);
end;

procedure TKSOperatorForm.ButtonWOLClick(Sender: TObject);
begin
  UpdateComputerMACs();
...
procedure TKSOperatorForm.TreeViewEditing(Sender: TObject; Node: TTreeNode;
  var AllowEdit: Boolean);
begin
  AllowEdit := false;
end;

procedure TKSOperatorForm.ButtonSelectCompsClick(Sender: TObject);
...
procedure TKSOperatorForm.ButtonSelectUsersClick(Sender: TObject);
var n: integer;
begin
  allow_onchange := false;
  Treeview.Items.BeginUpdate;
...
procedure TKSOperatorForm.FunctionAction(uid: integer);
var f: PFUNCTION;
  env: PENVENTRYDELPHI;
  n:   integer;
      ...
      with TreeView.Selections[n] do
        ...
        begin
          ...
          begin
            ...
            StrLCopy(d.kagami_ver, pchar(env.kagami_ver), sizeof(TSTRING) - 1);
...
procedure TKSOperatorForm.ButtonFunctionClick(Sender: TObject);
begin
  FunctionAction((Sender as TToolButton).Tag);
end;

procedure TKSOperatorForm.MenuFunctionClick(Sender: TObject);
begin
  FunctionAction((Sender as TMenuItem).Tag);
end;

procedure TKSOperatorForm.MinimizeToTray();
var w: HWND;
  r, r2: TRect;
begin
...
procedure TKSOperatorForm.FormClose(Sender: TObject;
...
procedure TKSOperatorForm.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TKSOperatorForm.TreeViewKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (not (ssCtrl in Shift)) and (not (ssShift in Shift)) then
  begin
    if key in [VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT, VK_PRIOR, VK_NEXT, VK_HOME, VK_END, VK_BACK, ord('0')
      ..ord('9'), ord('A')..ord('Z'), VK_ADD, VK_SUBTRACT] then
    begin
...
procedure TKSOperatorForm.UpdateServerStatus();
...
procedure TKSOperatorForm.UpdateCompList();
...
begin
 ...
 // build list of env in delphi format
  ...
  begin
    ...
    env.ip := t_env.ip;
    env.mac := t_env.mac;
    env.kagami_ver := t_env.kagami_ver;
...
{ count:=50;
        ...
        for m := 0 to TreeView.Items.Count - 1 do
          with TreeView.Items[m] do
            if (Level = 1) and
              ...
              (AnsiCompareText(PENVENTRYDELPHI(Data).comp_name, env.comp_name) = 0)
 //assume that in terminal server clients returns here GetComputerName()!!!
 ...
 // sort tree
  if IsTreeViewNeedToBeSorted(TreeView.Items.GetFirstNode) then
  // optimization because of center-item effect after sorting
...
procedure TKSOperatorForm.UpdateComputerMACs();
var n: integer;
  p:   PENVENTRYDELPHI;
  reg: TRegistry;
begin
...
procedure TKSOperatorForm.Timer1Timer(Sender: TObject);
begin
...
procedure TKSOperatorForm.TreeViewCompare(Sender: TObject; Node1,
...
procedure TKSOperatorForm.TreeViewDeletion(Sender: TObject;
  Node: TTreeNode);
...
procedure TKSOperatorForm.TreeViewAddition(Sender: TObject;
  Node: TTreeNode);
begin
  Node.Data := nil;
...
procedure TKSOperatorForm.TreeViewMouseDown(Sender: TObject;
...
procedure TKSOperatorForm.ButtonRefreshClick(Sender: TObject);
begin
  UpdateCompList();
end;

procedure TKSOperatorForm.TreeViewContextPopup(Sender: TObject;
  MousePos: TPoint; var Handled: Boolean);
begin
  Handled := true;
end;

procedure TKSOperatorForm.TreeViewMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var node: TTreeNode;
  p:      TPoint;
begin
...
procedure TKSOperatorForm.StatusBarDrawPanel(StatusBar: TStatusBar;
  Panel: TStatusPanel; const Rect: TRect);
var x, y: integer;
begin
...
initialization
  msg_login := RegisterWindowMessage('_KSOperatorFormLogin');
  msg_close := RegisterWindowMessage('_KSOperatorFormClose');
end.
