object CopyFilesForm: TCopyFilesForm
  ...
  Caption = #1050#1086#1087#1080#1088#1086#1074#1072#1090#1100' '#1092#1072#1081#1083#1099' '#1085#1072' '#1091#1095#1077#1085#1080#1095#1077#1089#1082#1080#1081' '#1082#1086#1084#1087#1100#1102#1090#1077#1088
  ClientHeight = 365
  ClientWidth = 395
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object Label2: TLabel
      ...
      Width = 306
      Height = 15
      Caption = #1055#1091#1090#1100' '#1076#1086#1083#1078#1077#1085' '#1073#1099#1090#1100' '#1089#1077#1090#1077#1074#1099#1084' '#1080' '#1076#1086#1089#1090#1091#1087#1085#1099#1084' '#1076#1083#1103' '#1091#1095#1077#1085#1080#1082#1086#1074'!'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clRed
      Font.Height = -12
      Font.Name = 'Segoe UI'
  ...
  object GroupBox2: TGroupBox
    ...
    object Label5: TLabel
      ...
      Width = 228
      Height = 15
      Caption = '%KS_USERFOLDER% - '#1087#1072#1087#1082#1072' '#1087#1086#1083#1100#1079#1086#1074#1072#1090#1077#1083#1103
    end
