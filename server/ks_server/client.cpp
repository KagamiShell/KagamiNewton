           ...
           if ( cmd_id == NETCMD_ADDSERVICESTR2BASE )
              {
                ...
                p_db->AddServiceString(s_computerloc,s_computerdesc,s_computername,s_ip,s_userdomain,s_username,s_id,s_count,s_size,s_time,s_comments);
              }
           else
           if ( cmd_id == NETCMD_ADDEVENTSTR2BASE )
              {
                ...
                p_db->AddEventString(s_computerloc,s_computerdesc,s_computername,s_ip,s_userdomain,s_username,s_level,s_comments);
              }
           else
