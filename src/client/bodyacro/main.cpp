...
FAILURE:
    ::MessageBox(NULL,"Acrobat Reader 7.0+ is needed!","Error",MB_ICONERROR | MB_OK);
    ::PostQuitMessage(0);
    ::error = 1;
    return 0;
}
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd)
{
...

	{
        	...
        	if ( !error )
        	{
                        BOOL show_panel = ReadRegDword(HKEY_CURRENT_USER,"Software\\KagamineP\\KagamiShell","show_pdf_panel",0);
