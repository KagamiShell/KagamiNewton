...
cl /Fekshell_svc /nologo /MT /MP /EHsc /O2s /DNDEBUG *.cpp ..\netclient.cpp ..\netcmd.cpp ..\f0.cpp ..\f1.cpp ..\servicemgr.cpp ..\install.cpp ..\cfg_def.cpp ..\cfg_impl.cpp ..\cfg_vars.cpp ..\cfg_common.cpp ..\md5.cpp ..\ourtime.cpp -link /MACHINE:X86 /TSAWARE kernel32.lib user32.lib advapi32.lib shlwapi.lib shell32.lib comctl32.lib ws2_32.lib netapi32.lib winmm.lib Iphlpapi.lib userenv.lib ole32.lib wiaguid.lib ..\..\z\z_lib.lib ..\..\kn_shared\kn_shared.lib resource.res
