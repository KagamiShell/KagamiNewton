...
static void InstallUninstallOurClassesInternal(BOOL b_inst)
{
  ...
  if ( b_inst )
     ActiveXRegister32("{CE2606AC-0A84-4272-97B0-04FF67BA05B6}","Newton CopyHook",s,"Apartment",NULL);
  else
  ...
  if ( IsWOW64() )
     {
       ...
       if ( b_inst )
          ActiveXRegister64("{CE2606AC-0A84-4272-97B0-04FF67BA05B6}","Newton CopyHook",s,"Apartment",NULL);
       else
  ...
  GetFileNameInLocalAppDir("knexhook.dll",s);
  if ( b_inst )
     ActiveXRegister32("{9BE88898-18E7-4528-8886-6358AAC2A61A}","Newton ShellExecuteHook",s,"Apartment",NULL);
  else
  ...
  if ( IsWOW64() )
     {
       GetFileNameInLocalAppDir("knexhook64.dll",s);
       if ( b_inst )
          ActiveXRegister64("{9BE88898-18E7-4528-8886-6358AAC2A61A}","Newton ShellExecuteHook",s,"Apartment",NULL);
       else
