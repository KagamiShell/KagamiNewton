...
procedure TKNDeskForm.WMQueryEndSession(var Message: TWMQueryEndSession);
begin
 Message.Result:=1;
end;

procedure TKNDeskForm.WMEndSession(var Message: TWMEndSession);
begin
 Message.Result:=0;
end;

procedure TKNDeskForm.WMEraseBkGnd(var Message: TWMEraseBkGnd);
begin
 Windows.PaintDesktop(Message.DC);
 Message.Result:=1;
end;

procedure TKNDeskForm.WMActivate(var Message: TWMActivate);
begin
 SetWindowPos(Handle,HWND_BOTTOM,0,0,0,0,SWP_NOMOVE or SWP_NOSIZE or SWP_NOACTIVATE or SWP_NOSENDCHANGING);
 Message.Result:=0;
end;

procedure TKNDeskForm.WMActivateApp(var Message: TWMActivateApp);
begin
 SetWindowPos(Handle,HWND_BOTTOM,0,0,0,0,SWP_NOMOVE or SWP_NOSIZE or SWP_NOACTIVATE or SWP_NOSENDCHANGING);
 Message.Result:=0;
end;

procedure TKNDeskForm.WMMouseActivate(var Message: TWMMouseActivate);
begin
 Message.Result:=MA_NOACTIVATE;
end;

procedure TKNDeskForm.WMClose(var Message: TWMClose);
begin
 Message.Result:=0;
end;

procedure TKNDeskForm.WMWindowPosChanging(var Message: TWMWindowPosChanging);
var p:PWINDOWPOS;
begin
...
procedure TKNDeskForm.WMSysKeyDown(var Message: TWMSysKeyDown);
begin
 Message.Result:=0;
end;

procedure TKNDeskForm.WMSysKeyUp(var Message: TWMSysKeyUp);
begin
 Message.Result:=0;
end;

procedure TKNDeskForm.WMKeyDown(var Message: TWMKeyDown);
begin
 Message.Result:=0;
end;

procedure TKNDeskForm.WMKeyUp(var Message: TWMKeyUp);
begin
 Message.Result:=0;
end;

procedure TKNDeskForm.WMSysChar(var Message: TWMSysChar);
begin
 Message.Result:=0;
end;
...
procedure TKNDeskForm.MyNavigate(const url:string);
begin
 FreeAndNil(theme);
