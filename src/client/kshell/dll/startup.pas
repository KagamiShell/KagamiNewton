...
function TKNStartupForm.FromMachineType2Idx(machine_type:integer):integer;
begin
 Result:=0;
...
function TKNStartupForm.FromIdx2MachineType(idx:integer):integer;
begin
...
begin
 ...
 Label7.Caption:='Обязательно выберите "Учительский компьютер" для учительского компьютера и "Домашний компьютер" для домашнего компьютера!';
 ...
 if not is_short then
  Label8.Caption:='Работа мастера завершена!'#13#10#13#10'Если производилось изменение настроек, то лучше выполнить перезагрузку компьютера'#13#10+#13#10'Мастер всегда можно запустить повторно из-под учетной записи администратора для изменения настроек'#13#10#13#10'ВКЛЮЧАТЬ оболочку лучше с серверной машины через программу оператора'#13#10#13#10'-------'#13#10'Нажмите "Завершить" для выхода'
 else
  Label8.Caption:='Работа мастера завершена!'#13#10#13#10'Если производилось изменение настроек, то лучше выполнить перезагрузку компьютера'#13#10+#13#10'Для повторного запуска мастера необходимо снова запустить программу установки клиента KagamiShell'#13#10#13#10'Управлять ученической частью нужно с учительского компьютера через программу оператора'#13#10#13#10'-------'#13#10'Нажмите "Завершить" для выхода';
 
 Label9.Caption:='Язык по умолчанию:';
 Label10.Caption:='Здесь можно указать список IP-адресов машин (через точку с запятой), с которых будет разрешено подключение к сервисам удаленного файлового менеджера и удаленного рабочего стола (обычно это учительский компьютер).'+' Если ничего не указывать, то будет разрешен доступ с любого компьютера.';
 ...
 if IsCyr then
  ...
  begin
   Caption:='KagamiShell Client setup';
...
begin
 if IsCyr then
  begin
   ...
   s_desc:='Номер компьютера:';
   s_ips:='IP-адрес или название компьютера:';
