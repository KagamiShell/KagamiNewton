...
type
     ...
     private
      ...
      function KNGetMachineLoc(Params: array of OleVariant): OleVariant;
      function KNGetMachineDesc(Params: array of OleVariant): OleVariant;
...
// WebBrowser.DPIAware:=true;
 ...
 WebBrowser.Bind('getMachineLoc',KNGetMachineLoc);
 WebBrowser.Bind('getMachineDesc',KNGetMachineDesc);
...
function TThemeHTML.KNGetMachineLoc(Params: array of OleVariant): OleVariant;
begin
...
function TThemeHTML.KNGetMachineDesc(Params: array of OleVariant): OleVariant;
begin
