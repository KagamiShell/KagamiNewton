...
static const TDEFSHORTCUT def_shortcut_00 =
    { 3128,
      "http://www.newton-shell.com",NULL,
      -1,
      -1 };
...
static const TDEFSHORTCUT def_shortcut_02 =
    { 3131,
      "%RS_FOLDER%\\bodywb.exe","-simple http://www.newton-shell.com",
      3221,
      3132 };
...
static const TDEFITEMLIST2 def_autorun_items[] = 
{
  ...
  {FALSE,"Start Page","$bodywb -simple http://newton-shell.com"},
{FALSE,NULL,NULL} //terminator
};
...
static const TGLOBALCFGITEM cfg_items[] = 
{
  ...
  // файлы: перенаправление для STUDENT
  ...
  { "fav_path",
    TRUE,  "fav_path",                             CFG_TYPE_PATH,    &fav_path,                        _C("%RS_STUDENTFOLDER%\\IEFav") },
  { "disallow_add2fav",
