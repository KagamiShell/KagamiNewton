...
{
  const char *szClassName = "_KNHostPicClass";
  WNDCLASS wc;
  ...
  HWND hwnd = CreateWindowEx(WS_EX_TOPMOST | WS_EX_TOOLWINDOW,szClassName,"KN Picture Host",WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_POPUP,0,0,GetSystemMetrics(SM_CXSCREEN),GetSystemMetrics(SM_CYSCREEN),NULL,NULL,instance,NULL);
