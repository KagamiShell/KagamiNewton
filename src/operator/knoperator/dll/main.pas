...
uses
  ...
  login, h_sql, global, sSkinManager, sSkinProvider, XPMan, TntStdCtrls,
  VasButton, bsSkinCtrls;


type
  TKNOperatorForm = class(TForm)
    Panel1: TPanel;
    ImageTop: TImage;
    ImageBottom: TImage;
    Panel2: TPanel;
...
procedure TKNOperatorForm.CreateFunctionButtons();
var n,idx:integer;
    p:PFunction;
    page:TTabSheet;
    panel:TPanel;
...
procedure TKNOperatorForm.CreateFunctionPopup();
...
function TKNOperatorForm.IsSQLConnected:boolean;
begin
 Result:=sql<>nil;
end;

procedure TKNOperatorForm.DefaultHandler(var Message);
begin
...
constructor TKNOperatorForm.CreateForm(p:PHostConnection);
var hIcon:cardinal;
begin
...
destructor TKNOperatorForm.Destroy;
begin
...
procedure TKNOperatorForm.SelfShow;
begin
 Visible:=true;
...
procedure TKNOperatorForm.SelfHide;
begin
 Visible:=false;
end;

function TKNOperatorForm.IsSelfVisible:boolean;
begin
 Result:=Visible;
end;

function TKNOperatorForm.GetSelfHWND:HWND;
begin
 Result:=Handle;
end;

procedure TKNOperatorForm.FormShow(Sender: TObject);
begin
 UpdateCompList();
 UpdateServerStatus();
 UpdateComputerMACs();
...
procedure TKNOperatorForm.FormResize(Sender: TObject);
var maxw:integer;
begin
...
procedure TKNOperatorForm.UpdateStatusString(panel:integer;s:string;process_messages:boolean);
begin
...
procedure TKNOperatorForm.UpdateView();
begin
...
procedure TKNOperatorForm.UpdateMachinesPage();
var item:TTreeNode;
    n:integer;
    p:PFUNCTION;
...
procedure TKNOperatorForm.ButtonConnectClick(Sender: TObject);
var cnt:integer;
    err:string;
begin
...
procedure TKNOperatorForm.ButtonDisconnectClick(Sender: TObject);
begin
...
procedure TKNOperatorForm.ButtonChangePassClick(Sender: TObject);
...
procedure TKNOperatorForm.ButtonDBViewClick(Sender: TObject);
var s:string;
begin
...
procedure TKNOperatorForm.ButtonWOLClick(Sender: TObject);
begin
 UpdateComputerMACs();
 ShowWOLFormModal(host);
end;

procedure TKNOperatorForm.MenuItemVipAddClick(Sender: TObject);
var s:string;
    rc:boolean;
    cnt:integer;
begin
...
procedure TKNOperatorForm.MenuItemVipDelClick(Sender: TObject);
var s:string;
    rc:boolean;
begin
...
procedure TKNOperatorForm.MenuItemVipClearPassClick(Sender: TObject);
var s:string;
    rc:boolean;
begin
...
procedure TKNOperatorForm.ButtonVipUsersClick(Sender: TObject);
var p:TPoint;
begin
 p.x:=0;
...
procedure TKNOperatorForm.TreeViewChange(Sender: TObject; Node: TTreeNode);
begin
 if allow_onchange then
   UpdateMachinesPage();
end;

procedure TKNOperatorForm.TreeViewEditing(Sender: TObject; Node: TTreeNode;
  var AllowEdit: Boolean);
begin
 AllowEdit:=false;
end;

procedure TKNOperatorForm.ButtonSelectCompsClick(Sender: TObject);
...
procedure TKNOperatorForm.ButtonSelectUsersClick(Sender: TObject);
var n:integer;
begin
 allow_onchange:=false;
 Treeview.Items.BeginUpdate;
...
procedure TKNOperatorForm.FunctionAction(uid:integer);
var f:PFUNCTION;
    env:PENVENTRYDELPHI;
    n:integer;
...
procedure TKNOperatorForm.ButtonFunctionClick(Sender: TObject);
begin
 FunctionAction((Sender as TToolButton).Tag);
end;

procedure TKNOperatorForm.MenuFunctionClick(Sender: TObject);
begin
 FunctionAction((Sender as TMenuItem).Tag);
end;

procedure TKNOperatorForm.MinimizeToTray();
var w:HWND;
    r,r2:TRect;
begin
...
procedure TKNOperatorForm.FormClose(Sender: TObject;
...
procedure TKNOperatorForm.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TKNOperatorForm.TreeViewKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TKNOperatorForm.UpdateServerStatus();
...
procedure TKNOperatorForm.UpdateCompList();
...
procedure TKNOperatorForm.UpdateComputerMACs();
var n:integer;
    p:PENVENTRYDELPHI;
    reg:TRegistry;
begin
...
procedure TKNOperatorForm.Timer1Timer(Sender: TObject);
begin
...
procedure TKNOperatorForm.TreeViewCompare(Sender: TObject; Node1,
...
procedure TKNOperatorForm.TreeViewDeletion(Sender: TObject;
  Node: TTreeNode);
...
procedure TKNOperatorForm.TreeViewAddition(Sender: TObject;
  Node: TTreeNode);
begin
 Node.Data:=nil;
...
procedure TKNOperatorForm.TreeViewMouseDown(Sender: TObject;
...
procedure TKNOperatorForm.ButtonRefreshClick(Sender: TObject);
begin
 UpdateCompList();
end;

procedure TKNOperatorForm.TreeViewContextPopup(Sender: TObject;
  MousePos: TPoint; var Handled: Boolean);
begin
 Handled:=true;
end;

procedure TKNOperatorForm.TreeViewMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var node:TTreeNode;
    p:TPoint;
begin
...
procedure TKNOperatorForm.StatusBarDrawPanel(StatusBar: TStatusBar;
  Panel: TStatusPanel; const Rect: TRect);
var x,y:integer;
begin
...
initialization
 msg_login:=RegisterWindowMessage('_KNOperatorFormLogin');
 msg_close:=RegisterWindowMessage('_KNOperatorFormClose');
end.
