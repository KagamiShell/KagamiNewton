...
const S_VIPADD = 'Добавление ученика';
const S_VIPDEL = 'Удаление ученика';
const S_VIPCLEARPWD = 'Очистка пароля ученика';
const S_ENTERVIPNAME = 'Введите имя пользователя:';
const S_VIPADDED = 'Ученик добавлен в базу!'#13#10'Теперь ученик должен выбрать "Регистрация ученика" на ученическом компьютере';
...
const S_VIPCLEARED = 'Пароль ученика очищен!'#13#10'Теперь ученик должен выбрать "Регистрация ученика" на ученическом компьютере';
...
const S_INFOFMT_VIPSESSION   = 'Ученик: %s';
