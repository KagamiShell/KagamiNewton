...
begin
 if conn then
  begin
   ...
   // Caption:=Application.Title + '  [Сервер: ' + LoginForm.GetServer() + ', Логин: ' + LoginForm.GetLogin() + ')';
   Caption:=Application.Title + ' —  [Пользователь ' + LoginForm.GetLogin() + ' подключен(-а) к серверу ' + LoginForm.GetServer() + ']';
   // UpdateStatusString(S_CONNECTED + '  (Сервер: ' + LoginForm.GetServer() + ', Логин: ' + LoginForm.GetLogin() + ')',false);
   UpdateStatusString(S_CONNECTED + '  [Пользователь: ' + LoginForm.GetLogin() + ', сервер: ' + LoginForm.GetServer() + ']',false);
