...
(
 ...
 (id:1;  title:'Работа с флешкой';       dbname:'работа с flash'),
...
(
  ...
  (defwidth:70;  title:'Ученик';         expr_ms:'TServices.vip_name';                                    expr_my:''),
...
(
  ...
  (defwidth:100; title:'Компьютер';  expr_ms:'+comp_desc';        expr_my:'CONCAT(comp_desc)'),
