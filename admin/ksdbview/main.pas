...
var col_services : array [0..8] of TCOLINFO =
(
  (defwidth:85;  title:'Время';       expr_ms:'TServices.time';                                        expr_my:''),
  (defwidth:100; title:'Услуга';      expr_ms:'TPrices.name';                                          expr_my:''),
  (defwidth:100; title:'Компьютер';  expr_ms:'TServices.comp_loc+''/''+TServices.comp_desc';          expr_my:'CONCAT(TServices.comp_loc,''/'',TServices.comp_desc)'),
...
var col_events : array [0..5] of TCOLINFO =
(
  (defwidth:85;  title:'Время';       expr_ms:'time';                            expr_my:''),
  (defwidth:55;  title:'Важность';    expr_ms:'level';                           expr_my:''),
  (defwidth:100; title:'Компьютер';  expr_ms:'comp_loc+''/''+comp_desc';        expr_my:'CONCAT(comp_loc,''/'',comp_desc)'),
...
(
  ...
  (defwidth:50;  title:'Класс';    expr_ms:'user_age';    expr_my:''),
...
begin
 ...
 filename:=IncludeTrailingPathDelimiter(string(p))+'ksdbview_tmp_log.html';
