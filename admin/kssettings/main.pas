...
var
  KSSettingsForm: TKSSettingsForm;
...
procedure TKSSettingsForm.AppMessage(var Msg: TMsg; var Handled: Boolean);
begin
...
procedure TKSSettingsForm.FormCreate(Sender: TObject);
begin
 CoInitialize(nil);
 ...
 msg_login:=RegisterWindowMessage('_KSSettingsFormLogin');
 Application.OnMessage := AppMessage;

 TVistaAltFix.Create(Self);
end;

procedure TKSSettingsForm.FormDestroy(Sender: TObject);
begin
...
procedure TKSSettingsForm.FormShow(Sender: TObject);
begin
 PostMessage(Handle,msg_login,0,0);
end;

procedure TKSSettingsForm.FormClose(Sender: TObject;
...
procedure TKSSettingsForm.UpdateStatusString(s:string;process_messages:boolean);
begin
...
procedure TKSSettingsForm.ButtonConnectClick(Sender: TObject);
var rc:boolean;
begin
...
procedure TKSSettingsForm.ButtonDisconnectClick(Sender: TObject);
begin
...
function TKSSettingsForm.TryConnect(server:string;server_type:integer;login,pwd:string):boolean;
var err:string;
begin
 FreeAndNil(sql);
...
procedure TKSSettingsForm.UpdateView(conn:boolean);
begin
 if conn then
  begin
...
procedure TKSSettingsForm.ButtonDBConfClick(Sender: TObject);
begin
 ExecLocalFile(PATH_DBCONF);
end;

procedure TKSSettingsForm.ButtonHelpClick(Sender: TObject);
begin
...
procedure TKSSettingsForm.TabSheet2Show(Sender: TObject);
begin
 ComboBoxSettType.ItemIndex:=0;
 ComboBoxSettType.OnSelect(ComboBoxSettType);
end;

function TKSSettingsForm.IsUserSettings:boolean;
begin
 Result:=ComboBoxSettType.ItemIndex=1;
end;

function TKSSettingsForm.IsCompSettings:boolean;
begin
 Result:=ComboBoxSettType.ItemIndex=2;
end;

procedure TKSSettingsForm.ComboBoxSettTypeSelect(Sender: TObject);
begin
...
procedure TKSSettingsForm.Panel8Resize(Sender: TObject);
begin
 Panel10.Height:=Panel8.Height div 2;
end;

procedure TKSSettingsForm.ListBoxVarsExit(Sender: TObject);
begin
 ListBoxVars.ItemIndex:=-1;
 SettingsPageSelectionChanged();
end;

procedure TKSSettingsForm.ListBoxCntsExit(Sender: TObject);
begin
 ListBoxCnts.ItemIndex:=-1;
 SettingsPageSelectionChanged();
end;

procedure TKSSettingsForm.Panel9Resize(Sender: TObject);
var w:integer;
begin
...
procedure TKSSettingsForm.ListViewRulesEditing(Sender: TObject;
  Item: TListItem; var AllowEdit: Boolean);
begin
 AllowEdit:=false;
end;

procedure TKSSettingsForm.SettingsPageSelectionChanged();
begin
...
begin
 Result:=TKSSettingsForm(i.user_parm).DBVarsProfilesNameCB(i);
end;

function TKSSettingsForm.DBVarsProfilesNameCB(i:PEXECSQLCBSTRUCT):boolean;
var f:pointer;
    s:string;
begin
...
begin
 Result:=TKSSettingsForm(i.user_parm).DBContentProfilesNameCB(i);
end;

function TKSSettingsForm.DBContentProfilesNameCB(i:PEXECSQLCBSTRUCT):boolean;
var f:pointer;
    s:string;
begin
 f:=i.GetFieldByName(i.obj,'name');
...
begin
 Result:=TKSSettingsForm(i.user_parm).DBRulesCB(i);
end;

function TKSSettingsForm.DBRulesCB(i:PEXECSQLCBSTRUCT):boolean;
...
procedure TKSSettingsForm.UpdateEntireSettingsPage();
...
procedure TKSSettingsForm.ListViewRulesChange(Sender: TObject;
  Item: TListItem; Change: TItemChange);
begin
 SettingsPageSelectionChanged();
end;

procedure TKSSettingsForm.ListViewRulesExit(Sender: TObject);
begin
 ListViewRules.Selected:=nil;
 SettingsPageSelectionChanged();
end;

procedure TKSSettingsForm.ListBoxVarsClick(Sender: TObject);
begin
 SettingsPageSelectionChanged();
end;

procedure TKSSettingsForm.ListBoxCntsClick(Sender: TObject);
begin
 SettingsPageSelectionChanged();
end;
...
function TKSSettingsForm.LoadProfileInternalBuffSize(name:string;profile_type:integer;_size:pinteger):pointer;
...
function TKSSettingsForm.LoadProfileInternal(name:string;profile_type,machine_type,lang:integer):boolean;
var buff:pointer;
    size:integer;
begin
 Result:=true;
...
function TKSSettingsForm.SaveProfileInternal(name:string;profile_type:integer):boolean;
var buff:pointer;
    size:integer;
...
procedure TKSSettingsForm.AddProfileInternal(lb:TListBox;profile_type:integer);
...
procedure TKSSettingsForm.EditProfileInternal(lb:TListBox;profile_type:integer);
var idx:integer;
    name:string;
    rc:boolean;
begin
...
procedure TKSSettingsForm.DeleteProfileInternal(lb:TListBox;profile_type:integer);
...
procedure TKSSettingsForm.ButtonVarsAddClick(Sender: TObject);
begin
 AddProfileInternal(ListBoxVars,0);
end;

procedure TKSSettingsForm.ButtonCntAddClick(Sender: TObject);
begin
 AddProfileInternal(ListBoxCnts,1);
end;

procedure TKSSettingsForm.ButtonVarsEditClick(Sender: TObject);
begin
 EditProfileInternal(ListBoxVars,0);
end;

procedure TKSSettingsForm.ButtonCntEditClick(Sender: TObject);
begin
 EditProfileInternal(ListBoxCnts,1);
end;

procedure TKSSettingsForm.ButtonVarsDelClick(Sender: TObject);
begin
 DeleteProfileInternal(ListBoxVars,0);
end;

procedure TKSSettingsForm.ButtonCntDelClick(Sender: TObject);
begin
 DeleteProfileInternal(ListBoxCnts,1);
end;

function TKSSettingsForm.GetListBoxIdx(lb:TListBox;const s:string):integer;
var n:integer;
begin
 Result:=-1;
...
function TKSSettingsForm.SaveAllRulesInternal:boolean;
var n:integer;
...
procedure TKSSettingsForm.ButtonRuleAddClick(Sender: TObject);
var rule:string;
...
procedure TKSSettingsForm.ButtonRuleEditClick(Sender: TObject);
var item:TListItem;
    rule:string;
    i_vars,i_cnts:integer;
    ar_vars,ar_cnts:array of string;
...
procedure TKSSettingsForm.ButtonRuleDelClick(Sender: TObject);
var item:TListItem;
    rc:boolean;
begin
 item:=ListViewRules.Selected;
...
procedure TKSSettingsForm.SwapRuleItemsContent(src,dest:integer);
var s:string;
begin
...
procedure TKSSettingsForm.ButtonRuleMoveUpClick(Sender: TObject);
var idx:integer;
    rc:boolean;
begin
...
procedure TKSSettingsForm.ButtonRuleMoveDownClick(Sender: TObject);
var idx:integer;
    rc:boolean;
begin
 if ListViewRules.Selected<>nil then
...
procedure TKSSettingsForm.ListBoxVarsKeyDown(Sender: TObject;
...
procedure TKSSettingsForm.ListBoxCntsKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
 if key=VK_DELETE then
  begin
...
procedure TKSSettingsForm.ListBoxVarsDblClick(Sender: TObject);
begin
 if ButtonVarsEdit.Enabled then
   ButtonVarsEditClick(Sender);
end;

procedure TKSSettingsForm.ListBoxCntsDblClick(Sender: TObject);
begin
 if ButtonCntEdit.Enabled then
   ButtonCntEditClick(Sender);
end;

procedure TKSSettingsForm.ListViewRulesDblClick(Sender: TObject);
begin
 if ButtonRuleEdit.Enabled then
  ButtonRuleEditClick(Sender);
end;

procedure TKSSettingsForm.ListViewRulesKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
 if key=VK_DELETE then
  begin
...
begin
 Result:=TKSSettingsForm(i.user_parm).DBUsersCB(i);
end;

function TKSSettingsForm.DBUsersCB(i:PEXECSQLCBSTRUCT):boolean;
var f:pointer;
    s:string;
begin
...
procedure TKSSettingsForm.UpdateEntireUsersPage();
begin
 ListBoxUsers.Clear;
...
procedure TKSSettingsForm.TabSheet1Show(Sender: TObject);
begin
 UpdateEntireUsersPage();
end;

procedure TKSSettingsForm.ListBoxUsersClick(Sender: TObject);
begin
 UsersPageSelectionChanged();
end;

procedure TKSSettingsForm.ListBoxUsersKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
 if key=VK_DELETE then
  begin
...
procedure TKSSettingsForm.ButtonUserAddClick(Sender: TObject);
var name,pwd:string;
    lb:TListBox;
    n:integer;
    find:boolean;
...
procedure TKSSettingsForm.ButtonUserEditClick(Sender: TObject);
var lb:TListBox;
    idx:integer;
    name,pwd:string;
    rc:boolean;
...
procedure TKSSettingsForm.ButtonUserDelClick(Sender: TObject);
var name:string;
    idx:integer;
    lb:TListBox;
    err:boolean;
...
procedure TKSSettingsForm.UsersPageSelectionChanged();
var lb:TListBox;
    idx:integer;
    user_name:string;
    i:TUSERRIGHTSCB;
...
function TKSSettingsForm.GetDefaultRightsString():string;
begin
...
procedure TKSSettingsForm.FillRightsPageFromString(s:string);
begin
...
function TKSSettingsForm.MakeStringFromRightsPage():string;
var s:string;
begin
 s:='';
...
function TKSSettingsForm.ApplyUserRightsInternal(user_name,rights:string):boolean;
var cnt:integer;
...
procedure TKSSettingsForm.ButtonSetRightsClick(Sender: TObject);
var lb:TListBox;
    idx:integer;
