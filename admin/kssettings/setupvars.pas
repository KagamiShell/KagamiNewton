...
const MAXLISTITEMS = 200;  // the same value in kshell\cfg_def.cpp, ks_shared and some bodytools
...
(
  ...
  (path:'res://%KS_FOLDER%\default\themes\01.theme//index.html';
   combo_idx:2; color:$C0C0C0),
  (path:'res://%KS_FOLDER%\default\themes\02.theme//index.html';
   combo_idx:3; color:$C0C0C0),
  (path:'res://%KS_FOLDER%\default\themes\03.theme//index.html';
   combo_idx:4; color:$4DC8F0),
  (path:'res://%KS_FOLDER%\default\themes\04.theme//index.html';
   combo_idx:5; color:$209DF4),
  (path:'%KS_FOLDER%\default\themes\05.theme';
