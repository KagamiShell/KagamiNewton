...
begin
  if not CheckAdminRights then
   begin
    MessageBox(0,'Программа должна запускаться ТОЛЬКО с правами администратора.','Ошибка',MB_OK or MB_ICONERROR);
    Exit;
   end;

  Application.Initialize;
  Application.Title := 'Сохранение/восстановление базы данных KagamiShell';
